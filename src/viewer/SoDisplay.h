...
class STBVIEWER_API SoDisplay : public SoNode
{
...
///////////////////
     ...
     *
     */
    void addTrackedItem(SoNode* trackedItem);
    
    void startUpdate(int framesPerSecond);
