...
#ifndef _EVENT_XIP_H_
#define _EVENT_XIP_H_
...
class Event_XIP //: public stb::Component//, public stb::VideoUser
{
public:
    /**
    *     The Constructor	
    ...
    */
    ...
    virtual EventXIPBus&               getEventBus();
...
protected:	
    ...
    typedef std::vector<std::string> SinkNameVector;
